...
var PointingPoker = function () {
  ...
  return {
    calculateVelocity: function () {
      ...
      ga('send', 'event', {
        eventCategory: 'GameActions',
        eventAction: 'calculatevelocity',
        eventLabel: estimateValue
      });
    },
    ...
    formSubmit: function () {
      ...
      if (name !== "" && _roomKey !== "") {
        ...
        ga('send', 'event', {
          eventCategory: 'GameActions',
          eventAction: 'enterroom',
          eventLabel: _roomKey + ":" + name
        });
    ...
    setGameType: function (gameType) {
      ...
      var page = document.location + "/games/" + gameType;
